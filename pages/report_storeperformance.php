...
<div class='col-sm-12'>
    <div class="row form-row">
        <div class="col-sm-8 col-sm-offset-2 formdiv">
            ...
            <form id="frmparameters" name="frmparameters" method="post" action="index.php?p=report_storeperformance&a=s"
...
<div class="col-md-12 col-lg-10 col-lg-offset-1">
    ...
    if ($a == 's') {
        ...
        if ($dataavailable == true) {
            ...
            // *
            // Report Title
            $title = "Store Performance Report for ";
            ...
            ?>
            <div class="col-sm-12">
                <?php if ($radStores == 'store' && $radDate == 'date') { ?>
                    <hr/>
                    <h4 style="color:#757575" class="text-center">Summary</h4>
                    <table class="table table-striped table-condensed">
                        <tr>
                            <td height="23" bgcolor="#007BC4" class="NormalText style1" width="10%">
                                <strong>Date</strong></td>
                            <td height="23" bgcolor="#007BC4" class="NormalText style1" width="9%"><strong>Avg Open
                                    Time </strong></td>
                            <td height="23" bgcolor="#007BC4" class="NormalText style1" width="9%">
                                <div align="right"><strong>Avg Table Spend</strong></div>
                            </td>
                            <td height="23" bgcolor="#007BC4" class="NormalText style1" width="9%">
                                <div align="right"><strong>Avg Void Amount</strong></div>
                            </td>
                            <td height="23" bgcolor="#007BC4" class="NormalText style1" width="9%">
                                <div align="right"><strong># of Reopened Checks</strong></div>
                            </td>
                            <td height="23" bgcolor="#007BC4" class="NormalText style1" width="9%">
                                <div align="right"><strong># of Splits</strong></div>
                            </td>
                            <td height="23" bgcolor="#007BC4" class="NormalText style1" width="9%">
                                <div align="right"><strong># Of Transfers</strong></div>
                            </td>
                            <td height="23" bgcolor="#007BC4" class="NormalText style1" width="9%">
                                <div align="right"><strong>Clears</strong></div>
                            </td>
                            <td height="23" bgcolor="#007BC4" class="NormalText style1" width="9%">
                                <div align="right"><strong># of Clears</strong></div>
                            </td>
                            <td height="23" bgcolor="#007BC4" class="NormalText style1" width="9%">
                                <div align="right"><strong>Refunds</strong></div>
                            </td>
                            <td height="23" bgcolor="#007BC4" class="NormalText style1" width="9%">
                                <div align="right"><strong># of Refunds</strong></div>
                            </td>
                        </tr>
                        <?php
                        // ************************************************
                        ...
                        $headings = array($title, '');
                        $worksheet->write_row('L10', $headings, $RightNumberTotalBold);
                        ...
                        $title = "No. of Clears";
                        $headings = array($title, '');
                        $worksheet->write_row('N10', $headings, $RightNumberTotalBold);

                        $title = "Refunds Value";
                        $headings = array($title, '');
                        $worksheet->write_row('O10', $headings, $RightNumberTotalBold);

                        $title = "No. of Refunds";
                        $headings = array($title, '');
                        $worksheet->write_row('P10', $headings, $RightNumberTotalBold);
                        ...
                        $result = GetStorePerfomance($sumid);//GetCompsSummary($sumid);
                        while ($row = mysql_fetch_array($result)) {
                            // $qty = $qty + intval($row["cbrcompcount"]);
                            // $amount = $amount + floatval($row["cbrcompamount"]);
                            ?>
                            <tr>
                                <td class="NormalText" width="10%"><?php echo substr($row["sumdate"], 0, 10); ?></td>
                                <td class="NormalText" width="9%"><?php echo $row["AverageOpenTime"]; ?></td>
                                <td class="NormalText" width="9%">
                                    <div align="right"><?php echo $row["AverageSpendPerTable"]; ?></div>
                                </td>
                                <td class="NormalText" width="9%">
                                    <div align="right"><?php echo $row["AverageVoidAmount"]; ?></div>
                                </td>
                                <td class="NormalText" width="9%">
                                ...
                                <td class="NormalText" width="9%">
                                    <div align="right"><?php echo $row["NoOfClears"]; ?></div>
                                </td>
                                <td class="NormalText" width="9%">
                                    <div align="right"><?php echo $row["RefundsValue"]; ?></div>
                                </td>
                                <td class="NormalText" width="9%">
                                    <div align="right"><?php echo $row["NoOfRefunds"]; ?></div>
                                </td>
                            </tr>
                            ...
                            $title = $row["TransfersValue"];
                            $headings = array($title, '');
                            $worksheet->write_row('K' . $rownumber, $headings, $num1_format);

                            $title = $row["NoOfTransfers"];
                            $headings = array($title, '');
                            $worksheet->write_row('L' . $rownumber, $headings, $num1_format);

                            $title = $row["ClearsValue"];
                            $headings = array($title, '');
                            $worksheet->write_row('M' . $rownumber, $headings, $num1_format);

                            $title = $row["NoOfClears"];
                            $headings = array($title, '');
                            $worksheet->write_row('N' . $rownumber, $headings, $num1_format);

                            $title = $row["RefundsValue"];
                            $headings = array($title, '');
                            $worksheet->write_row('O' . $rownumber, $headings, $num1_format);

                            $title = $row["NoOfRefunds"];
                            $headings = array($title, '');
                            $worksheet->write_row('P' . $rownumber, $headings, $num1_format);
                            $rownumber++;
                        } ?>
                ...
                <?php if ($radStores == 'storegroup' || $radDate == 'daterange') { ?>
                    ...
                    <table class="table table-striped table-condensed">
                        <tr>
                            ...
                            <td height="23" bgcolor="#007BC4" class="NormalText style1" width="9%">
                                <div align="right"><strong>Avg Void</strong></div>
                            </td>
                            <td height="23" bgcolor="#007BC4" class="NormalText style1" width="9%">
                                <div align="right"><strong># of Reopened Checks</strong></div>
                            </td>
